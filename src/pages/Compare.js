...
import charactersData from '../data/characters.json'; // adjust the path as needed
...
const CompareCharactersPage = () => {
    ...
    // transform the capacities to the format required by RadarChart
    const data = [
    ...
    return (
        <>
            ...
            {charactersData[option1.value].thumbnail && 
                <img src={`${charactersData[option1.value].thumbnail.path}/standard_large.${charactersData[option1.value].thumbnail.extension}`} alt={option1.label} />
            }

            {charactersData[option2.value].thumbnail && 
                <img src={`${charactersData[option2.value].thumbnail.path}/standard_large.${charactersData[option2.value].thumbnail.extension}`} alt={option2.label} />
            }
            </div>
            <p style={centerStyle}>
            ...
            <RadarChart cx={300} cy={250} outerRadius={150} width={600} height={500} data={data}>
                ...
                <PolarRadiusAxis />
                <Radar name={option1.label} dataKey="A" stroke="#8884d8" fill="#8884d8" fillOpacity={0.6} />
